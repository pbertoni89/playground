...
baba = pdr.get_data_yahoo('BABA', start=start, end=end)
print(baba)
...
stock = ['BAC', 'GS', 'JPM', 'MS']
data = pdr.DataReader(stock, data_source="yahoo", start='12/01/2017', end='12/31/2017')['Adj Close']
...
# Create scatter plot colored by various Sharpe Ratios with standard deviation on the x-axis and returns on the y-axis
