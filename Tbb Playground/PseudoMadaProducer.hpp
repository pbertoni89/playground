...
/*
	...
	and it is safe to process each element concurrently.
	Here is the sequential code to do this:
*/
	void foo(float f);
	/*{
...
class PseudoMadaProducer
{
	...
	/** 
		An instance of PseudoMadaProducer needs member fields that remember all the local variables
