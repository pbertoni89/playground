...
static real_T c_emlrt_marshallIn(const mxArray *threshold, const char_T
  *identifier);
static real_T d_emlrt_marshallIn(const mxArray *u, const emlrtMsgIdentifier
  *parentId);
static void e_emlrt_marshallIn(const mxArray *src, const emlrtMsgIdentifier
  *msgId, emxArray_real_T *ret);
static void emlrt_marshallIn(const mxArray *originalImage, const char_T
  ...
  *identifier, emxArray_real_T *y)
{
  ...
  thisId.fParent = NULL;
  thisId.bParentIsCell = false;
  b_emlrt_marshallIn(emlrtAlias(originalImage), &thisId, y);
...
void sobel_api(const mxArray * const prhs[2], const mxArray *plhs[1])
{
  ...
  emxInit_real_T(&originalImage, 2, true);
  emxInit_uint8_T(&edgeImage, 2, true);

  /* Marshall function inputs */
  emlrt_marshallIn(emlrtAlias(prhs[0]), "originalImage", originalImage);
