...
int main_dynamic_load(int argc, const char **argv)
{
	...
	std::cout << "# Connector/C++ dynamic loading.." << std::endl;
	...
	try {
		/*
			...
			any constant std::string containing the path of an alternate client library.
	...
	std::cout << "ok 1 - examples/dynamic_load.cpp" << std::endl;
	return EXIT_SUCCESS;
}
