// Boost Normal Distribution.cpp : Defines the entry point for the console application.
//
	...
	try
	{
		...
		}
		{
			...
			*/
			...
			boost::math::normal sacks(mean, standard_deviation);
		...
		{ // K. Krishnamoorthy, Handbook of Statistical Distributions with Applications,
		  ...
		  */
			...
			boost::math::normal packs(mean, standard_deviation);
			...
			boost::math::normal xpacks(over_mean, standard_deviation);
			...
			boost::math::normal nominal_packs(nominal_mean, standard_deviation);
			...
			*/
			...
			cout << "Quantile of " << p << " = " << quantile(packs, p)
				<< ", mean = " << packs.mean() << ", sd = " << packs.standard_deviation() << endl; //
																								   ...
																								   */
			boost::math::normal pack05(mean, 0.05);
			...
			*/
			...
			boost::math::normal pack06(mean, 0.06);
			...
			*/
			...
			boost::math::normal s; // For standard normal distribution,
			double sd = 0.1;
			...
			boost::math::normal pack95(mean, sd95);  // Distribution of the 'ideal better' packer.
			cout << "Fraction of packs >= " << under_weight << " with a mean of " << mean
		...
		{ // K. Krishnamoorthy, Handbook of Statistical Distributions with Applications,
		  ...
		  */
		  ...
		  boost::math::normal bolts(3.95, 0.1);
			double top = 4.1;
			double bottom = 3.9;
