...
void pbfib_api(const mxArray * const prhs[1], const mxArray *plhs[1])
{
  real_T n;

  /* Marshall function inputs */
  n = emlrt_marshallIn(emlrtAliasP((const mxArray *)prhs[0]), "n");
...
void pbfib_terminate(void)
{
  emlrtLeaveRtStackR2012b(emlrtRootTLSGlobal);
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
}

/* End of code generation (_coder_pbfib_api.c) */
